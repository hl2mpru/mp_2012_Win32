...
void EventList_RegisterSharedEvents( void )
{
	...
	//hl2mp.ru - AE_CL_PLAYSOUND не работает на стороне клиента, добавил AE_TYPE_SERVER!
	//Смотри baseanimating.cpp 1148
	REGISTER_SHARED_ANIMEVENT( AE_CL_PLAYSOUND, AE_TYPE_CLIENT | AE_TYPE_SERVER );
