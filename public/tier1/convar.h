...
public:
    ...
    // ”далЄнные методы
private:
    void Init(const char *pName, bool bIgnoreMissing); // = delete заменЄн на private
    IConVar* GetLinkedConVar(); // = delete заменЄн на private
    void SetValue(const char *pValue); // = delete заменЄн на private
